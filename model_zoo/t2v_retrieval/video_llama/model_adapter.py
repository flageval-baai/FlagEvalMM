...
from flagevalmm.server.utils import get_data, parse_args, get_retrieval_data
...
class ModelAdapter(BaseModelAdapter):
    def model_init(self, task_info: Dict) -> None:
        ...
        self.processor = AutoProcessor.from_pretrained(task_info["model_path"], trust_remote_code=True)
    ...
    def run_one_task(self, task_name: str, meta_info: Dict[str, Any]):
        ...
        caption = [
                ...
                for caption_id in range(text_num)
        ]
        ...
        for i in tqdm(range(text_num)):            
            for j in range(0,text_num,itd):
                ...
                arr=np.pad(arr, _e-_s-arr.shape[0], 'constant', constant_values=(0.0))

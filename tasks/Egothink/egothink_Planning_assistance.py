config = dict(
    dataset_path="/share/project/xuyijie/datasets/EgoThink___ego_think/Planning_assistance",
    split="all",
    processed_dataset_path="egothink_Planning_assistance",
...
Answer the questions in a detailed and helpful way.
""",   # prompt 前缀
        post_prompt=""   # prompt 后缀
    ),
    name="egothink_Planning_assistance",
)

config = dict(
    dataset_path="/share/project/xuyijie/datasets/EgoThink___ego_think/Object_attribute",
    split="all",
    processed_dataset_path="egothink_Object_attribute",
...
""",   # prompt 前缀
    ...
    name="egothink_object_attribute",
)

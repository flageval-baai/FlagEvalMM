config = dict(
    dataset_path="/share/project/xuyijie/datasets/EgoThink___ego_think/Localization_location",
    split="all",
    processed_dataset_path="egothink_Localization_location",
...
""",   # prompt 前缀
    ...
    name="egothink_localization_location",
)

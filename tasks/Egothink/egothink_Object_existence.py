config = dict(
    dataset_path="/share/project/xuyijie/datasets/EgoThink___ego_think/Object_existence",
    split="all",
    processed_dataset_path="egothink_Object_existence",
...
""",   # prompt 前缀
    ...
    name="egothink_object_existence",
)

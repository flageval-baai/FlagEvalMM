config = dict(
    dataset_path="/share/project/xuyijie/datasets/EgoThink___ego_think/Reasoning_situated",
    split="all",
    processed_dataset_path="egothink_Reasoning_situated",
...
""",   # prompt 前缀
    ...
    name="egothink_Reasoning_situated",
)

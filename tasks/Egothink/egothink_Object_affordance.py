config = dict(
    dataset_path="/share/project/xuyijie/datasets/EgoThink___ego_think/Object_affordance",
    split="all",
    processed_dataset_path="egothink_Object_affordance",
...
""",   # prompt 前缀
    ...
    name="egothink_object_affordance",
)

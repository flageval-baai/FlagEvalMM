config = dict(
    dataset_path="/share/project/xuyijie/datasets/EgoThink___ego_think/Localization_spatial",
    split="all",
    processed_dataset_path="egothink_Localization_spatial",
...
""",   # prompt 前缀
    ...
    name="egothink_localization_spatial",
)

config = dict(
    dataset_path="/share/project/xuyijie/datasets/EgoThink___ego_think/Planning_navigation",
    split="all",
    processed_dataset_path="egothink_Planning_navigation",
...
""",   # prompt 前缀
    ...
    name="egothink_Planning_navigation",
)
